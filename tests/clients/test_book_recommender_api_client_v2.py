...
async def test_successful_get_books_read(httpx_mock, caplog: LogCaptureFixture,
    ...
    # Given
    caplog.set_level("INFO", logger="book_recommender_api_client_v2")
    httpx_mock.add_response(json={"book_ids": [3, 4, 5]}, status_code=200, url="https://testurl/reviews/1/book-ids")
...
#                                                                           book_recommender_api_client_v2: BookRecommenderApiClientV2):
#     # Given
#     caplog.set_level("DEBUG", logger="book_recommender_api_client_v2")
#     httpx_mock.add_response(json={"book_ids": [3, 4, 5]}, status_code=200, url="https://testurl/reviews/1/book-ids")
#     httpx_mock.add_response(json={"book_ids": [6, 7, 8]}, status_code=200, url="https://testurl/reviews/2/book-ids")
#
#     # When
#     for _ in range(0, 10):
#         await book_recommender_api_client_v2.get_books_read_by_user(1)
#
#     await book_recommender_api_client_v2.get_books_read_by_user(2)
#
#     # Then
...
async def test_unhandled_exceptions_when_getting_books_read_throws_exception(httpx_mock, caplog: LogCaptureFixture,
    ...
    assert_that(e.value.args[0]).contains("Unable to read within timeout", "https://testurl/reviews/1/book-ids")
...
async def test_successful_user_review_creation(httpx_mock, caplog: LogCaptureFixture,
                                               book_recommender_api_client_v2: BookRecommenderApiClientV2):
    # Given
    httpx_mock.add_response(json={"indexed": 1}, status_code=200, url="https://testurl/reviews/batch/create")
...
async def test_batch_correctly_takes_indexed_from_api_not_input(httpx_mock, caplog: LogCaptureFixture,
                                                                book_recommender_api_client_v2: BookRecommenderApiClientV2):
    # Given
    httpx_mock.add_response(json={"indexed": 2}, status_code=200, url="https://testurl/reviews/batch/create")
...
async def test_429_user_review_creation_throws_exception(httpx_mock, caplog: LogCaptureFixture,
    ...
    assert_that(caplog.text).contains("Received 429 response code", "https://testurl/reviews/batch/create")
...
async def test_5xx_user_review_creation_throws_exception(httpx_mock, caplog: LogCaptureFixture,
    ...
    assert_that(caplog.text).contains("Received 5xx exception from server", "https://testurl/reviews/batch/create")
...
async def test_unhandled_exceptions_when_creating_user_review_throws_exception(httpx_mock,
    ...
    assert_that(e.value.args[0]).contains("Unable to read within timeout", "https://testurl/reviews/batch/create")
